...
export default function Home(){
    ...
    return <>
        ...
        {stateContents.length? 
            stateContents[0] === false? <h3 className="alert alert-secondary w-100 text-center">No Content Exist</h3>
            :
            <>
                ...
                {/* Content Slider Section */}
                    <div id="contentSlider" className="carousel slide w-75 m-auto mb-3">
                        ...
                        <div className="carousel-inner">
                            {sliderContents.map((content, i)=>
                                <div className={"carousel-item "+(i===0?"active":"")} key={i} onClick={()=>{navigate(contentRoute+content.link)}}>
