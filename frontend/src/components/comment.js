...
function Comment() {
    ...
    const submitComment = e =>{
        ...
        fetch(process.env.REACT_APP_API_SERVER + "/content/comments",{
            method:'post',
            credentials: "include",
            body: data
        }).then(async res=>{
    ...
    return (
        <div className="comments row mb-3 position-relative">
                        ...
                        comments.map((comment, i) =>
                            <div className="comment col-md-10 pt-3" data-index={i} key={comment._id} id={`id${comment._id}`}>
                                ...
                                <div className="comment-body mt-3">
                                    {!comment.editMode && <div className="content" style={{backgroundColor: "#ededed"}}>
