...
router.put('/profile/update', isLoggedIn, (req, res, next)=>{ 
    if(['66db3bc377c6ad39f86a330d', '66fd9be2c3497fc2d0797831', '66fd9c07c3497fc2d0797835', '66fd9c2fc3497fc2d0797839', '670027ec24a2f729b806c7df'].includes(String(req.session.user._id)))
...
router.delete("/delete", isLoggedIn, (req, res, next)=>{
    const usersArr = ['66db3bc377c6ad39f86a330d', '66fd9be2c3497fc2d0797831', '66fd9c07c3497fc2d0797835', '66fd9c2fc3497fc2d0797839', '670027ec24a2f729b806c7df']
